...
static void RedoxProcess_writeField(const Process* this, RichString* str, ProcessField field) {
   const RedoxProcess* up = (const RedoxProcess*) this;
...
static int RedoxProcess_compareByKey(const Process* v1, const Process* v2, ProcessField key) {
   const RedoxProcess* p1 = (const RedoxProcess*)v1;
   const RedoxProcess* p2 = (const RedoxProcess*)v2;
...
const ProcessClass RedoxProcess_class = {
   .super = {
   ...
   .writeField = RedoxProcess_writeField,
   .compareByKey = RedoxProcess_compareByKey
};
